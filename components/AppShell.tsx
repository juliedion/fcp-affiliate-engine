...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="shell"><aside className="sidebar"><div className="brand">FORT <span>CRAZYPANTS</span></div><div className="tagline">Deals, steals & smart reveals</div><nav className="nav">
    <Link className={isActive("/") ? "active" : ""} href="/">✦ Find Engine</Link>
    <Link className={isActive("/products") ? "active" : ""} href="/products">▦ Saved Finds</Link>
    <Link className={isActive("/winning-products") ? "active" : ""} href="/winning-products">🔥 Find Ideas</Link>
